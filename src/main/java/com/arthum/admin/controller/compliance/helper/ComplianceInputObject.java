...
public class ComplianceInputObject {
    String companyId;
    String factoryId;
    String principalId;
    String employeeId;
    String month;
public ComplianceInputObject(Map<String,Object> payload)
{
    ...
    public ComplianceInputObject(String companyId, String principalId, String factoryId) {
